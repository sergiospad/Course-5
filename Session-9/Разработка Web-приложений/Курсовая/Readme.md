...
<br>+ Тема курсовой должна быть в кавычках В ВЕРХНЕМ РЕГИСТРЕ. Если нужны кавычки в кавычках, то несколько подряд закрывающих кавычек ставить не нужно по правилам русского языка:

«АВТОМАТИЗИРОВАННАЯ ИНФОРМАЦИОННАЯ СИСТЕМА «МИКРОБЛОГ»

Использовать разные типы кавычек в одном предложении запрещено. Знаю, самому неприкольно как программисту оставлять незакрытую скобку.

 <br>+ Инициалы выполняющего работу и проверяющего должны находиться ровно друг под другом:
