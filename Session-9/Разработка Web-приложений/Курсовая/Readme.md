...
- Понятное дело, структурный элемент не нумеруется, а заголовок нумеруется. При этом в любом заголовоке и подзаголовке последняя точка при нумерации не ставится. 
