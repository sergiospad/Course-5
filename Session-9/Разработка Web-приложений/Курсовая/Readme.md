...
<br>+ Тема курсовой должна быть в кавычках В ВЕРХНЕМ РЕГИСТРЕ. Если нужны кавычки в кавычках, то несколько подряд закрывающих кавычек не ставить по правилам русского языка:
